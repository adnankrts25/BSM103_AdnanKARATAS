...
public class StockMain {
	...
	public static void main(String[] args) {
		Scanner console = new Scanner(System.in);
		 ...
		 System.out.print("ilk maðaza ismi :");
	...
	public static int makePurchases(Stock currentStock ,Scanner console ) {
		...
		int currentPrince= console.nextInt();
		
		int profit = currentStock.getProfit(currentPrince);
		System.out.println("net kazancý/kayýp: " + profit +"TL");
		System.out.println();
		return profit;
